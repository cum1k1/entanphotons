...
void Waveforms_calibration_nprocs(
    TString source_path = "/entanglement_new_files/entanglement/two_GAGG/october_2_gagg/Co57_calibr/resoldered_amplifiers/",
    TString file_name = "/entanglement_new_files/entanglement/two_GAGG/october_2_gagg/Co57_calibr/resoldered_amplifiers/1.root",TString temp_DIR = "", TString postfix = "_0")
{
    ...
    for (Int_t channel_number = 34; channel_number < 36; channel_number++)
    ...
    //////////////////////Fill_clibrated_tree
                    for (Long_t entry_num = Events_for_cuts_left;  entry_num< Events_for_cuts_right; entry_num++)
                    {
                        ...
                        for (Int_t channel_number = 0; channel_number < total_channels; channel_number++)
                        {
                            ...
                            Int_t CH_GATE_END = GATE_END; if (channel_number == 32 || channel_number ==33) CH_GATE_END = Gate_end_for_main_scatterers; if (channel_number == 34 || channel_number == 34) CH_GATE_END = Intermediate_gate;
                            ...
                            {   if (channel_number == 34 || channel_number == 35 || channel_number == 36 || channel_number == 37)
                                {
